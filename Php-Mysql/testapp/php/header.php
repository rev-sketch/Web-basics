    ...
    <section class="row content-header">
      ...
      <div class="col-md-1 user_options">
        ...
        <ul id="options" class="options list-unstyled" style="display: none;">
          <li>
            <a><i class="fa fa-user"></i><span>'.$_SESSION["userlogin"].'</span></a>
          </li>
          <li>
          <a href="update.php"><i class="fa fa-edit"></i><span>Change Password</span></a>
         </li>
          <li>
            <a href="index.php"><i class="fa fa-key"></i><span>Logout</span></a>
          </li>
