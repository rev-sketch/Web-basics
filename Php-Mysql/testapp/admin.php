      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_agent.php', 'Total Agents', 'agent');
              createSection1('manage_clients.php', 'Total Clients', 'client');
            ?>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'add_agent.php', 'Add New Agent');
            // createSection2('address-card', 'add_client.php', 'Add New client');
          ?>
